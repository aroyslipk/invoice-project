...
"""
URL configuration for the API endpoints of the 'Invoice' app.
All URLs defined here are prefixed with '/api/' by the root URL configuration.
"""
...
urlpatterns = [
    ...
    # Using <int:id> because the Price model uses a default integer primary key.
